...
export default function GovernmentAnalyticsPage() {
  const { application, events, queries, inspection, currentPersona } = useAppStore();
  ...
  // Inspection counts derived strictly from store
  const totalInspections = inspection ? 1 : 0;
  ...
  let isHeroDurationAvailable = false;
  ...
  if (application.submittedAt && application.decidedAt) {
    ...
    isHeroDurationAvailable = true;
  }

  // SLA Performance derived strictly from real record
  const isWithinSLA = application.slaDays ? true : false;
    ...
    <div className="page-body">
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
          <Link href="/government/applications" className="btn btn-secondary">
      ...
      <div className="grid-2" style={{ marginBottom: '24px' }}>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <Link href="/government/applications" className="btn btn-secondary btn-sm">
              Open Queue
            </Link>
          </div>
