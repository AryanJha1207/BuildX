...
export default function EntrepreneurDashboardPage() {
  const { business, application, queries, inspection, events, notifications } = useAppStore();
      ...
      <div className="grid-2" style={{ marginBottom: '24px' }}>
        ...
        <div className="card">
          ...
          <div style={{ marginTop: '16px', paddingTop: '12px', borderTop: '1px solid #f1f5f9', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Link href="/roadmap" className="btn btn-primary btn-sm">
      ...
      <div className="grid-2" style={{ marginBottom: '24px' }}>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <Link href="/incentives" className="btn btn-secondary btn-sm">
              View All 4
            </Link>
          </div>
          ...
          <div style={{ marginTop: '16px', paddingTop: '12px', borderTop: '1px solid #f1f5f9', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Link href="/incentives" className="btn btn-primary btn-sm">
