...
export default function QueryDetailPage() {
  ...
  const { queries, respondToQuery, application, business } = useAppStore();
  ...
  const [attachedFileName, setAttachedFileName] = useState('FreshChain_Process_Flow_v2.pdf');
    ...
    <div className="page-body">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          ...
          <Link href={`/application/${application.id}`} className="btn btn-outline-primary">
