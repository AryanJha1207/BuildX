...
const entSteps = [
  ...
  },
  {
    ...
    desc: 'AI rule engine identifies every approval you need',
    color: '#1a3a8a',
    bg: '#eef3ff',
  ...
  },
  {
    num: '3',
    title: 'Your Roadmap',
    desc: 'Ordered approval pathway with documents & status',
    color: '#16a34a',
    bg: '#f0fdf4',
  ...
  },
  {
    ...
    desc: 'Pre-validation catches missing docs and format errors before you submit',
    color: '#7c3aed',
    bg: '#f5f3ff',
  ...
  },
  {
    ...
    desc: 'Live dashboard for status, query responses, SLA alerts, and final decisions',
    color: '#0891b2',
    bg: '#ecfeff',
...
const govSteps = [
  {
    ...
    desc: 'Officer receives and reviews documents, business info, and pre-validation results',
  ...
  {
    title: 'Query & Inspect',
    desc: 'Raise queries, get entrepreneur responses, schedule and complete inspections',
  ...
  {
    title: 'Decide & Notify',
    desc: 'Approve or reject. Entrepreneur notified instantly. Roadmap and compliance auto-updates',
        ...
        <div className="hiw-steps">
          {entSteps.map((step) => (
            <div key={step.num} className="hiw-step">
              <div className="hiw-step-icon-wrap" style={{ background: step.bg, boxShadow: `0 4px 20px ${step.color}20` }}>
